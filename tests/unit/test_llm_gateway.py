...
class TestCircuitBreaker:
    ...
    def test_circuit_breaker_opens_after_failures(self):
        ...
        assert (
            gateway.circuit_breakers.get("gpt-4o-mini")
    ...
    def test_circuit_breaker_prevents_calls_when_open(self):
        ...
        assert "unavailable" in str(exc_info.value).lower() or "circuit breaker" in str(exc_info.value).lower()
...
class TestCaching:
    ...
    def test_cache_hit_returns_cached(self):
        ...
        gateway = LLMGateway(
            ...
            llm_call_handler=counting_llm_call,
            enable_caching=True
        )
