...
class TestCORSConfig:
    ...
    def test_cors_config_custom_origins(self):
        ...
        origins = ["http://localhost:3000", "https://example.com", "https://*.example.com"]
...
class TestGetStats:
    ...
    def test_counts_requests(self):
        ...
        stats = {"total_requests": 0, "blocked_requests": 0, "preflight_requests": 0}
    ...
    def test_counts_blocked(self):
        ...
        stats = {"total_requests": 0, "blocked_requests": 0}
