...
class TestQualityFallbacks:
    ...
    def test_suggest_fallback_for_low_quality(self):
        ...
        score = assessor.assess(
            query, response, sources=[{"source_type": "rag", "relevance_score": 0.2}]
        )
...
class TestSourceQualityAssessment:
    ...
    def test_rag_sources_are_highly_reliable(self):
        ...
        sources = [{"source_type": "rag", "relevance_score": 0.9}]
    ...
    def test_web_sources_moderately_reliable(self):
        ...
        sources = [{"source_type": "web", "relevance_score": 0.7}]
...
class TestQualityScoreDataclass:
    ...
    def test_quality_score_contains_components(self):
        ...
        score = QualityScore(
            relevance=0.8, completeness=0.85, confidence=0.7, source_quality=0.9, overall=0.8125
        )
    ...
    def test_quality_score_all_floats(self):
        ...
        score = QualityScore(
            relevance=0.5, completeness=0.6, confidence=0.7, source_quality=0.8, overall=0.65
        )
