...
class TestRateLimitConfig:
    ...
    def test_rate_limit_config_custom_limits(self):
        ...
        config = {"default_limit": 500, "default_window": 300, "llm_limit": 50}
...
class TestTokenBucket:
    ...
    def test_bucket_starts_full(self):
        ...
        bucket = {"tokens": 100, "capacity": 100, "refill_rate": 1.667}
        assert bucket["tokens"] == bucket["capacity"]

    def test_consume_reduces_tokens(self):
        """Test that consume reduces available tokens."""
        bucket = {"tokens": 100, "capacity": 100}
        bucket["tokens"] -= 1
    ...
    def test_respects_capacity(self):
        ...
        bucket = {"tokens": 90, "capacity": 100, "refill_rate": 50.0}
...
class TestCheckRateLimit:
    ...
    def test_reset_at_set(self):
        ...
        result = {"reset_at": datetime.now() + timedelta(seconds=60)}
        assert result["reset_at"] is not None

    def test_different_endpoints(self):
        """Test different endpoints have separate limits."""
        endpoints = {"/api/users": {"tokens": 50}, "/api/llm": {"tokens": 10}}
...
class TestGetOrCreateBucket:
    ...
    def test_creates_new_bucket(self):
        ...
        if user_id not in buckets:
            buckets[user_id] = {"tokens": 100, "capacity": 100, "created_at": datetime.now()}
    ...
    def test_per_endpoint_isolation(self):
        ...
        buckets = {"user1:/api/users": {"tokens": 50}, "user1:/api/llm": {"tokens": 15}}
...
class TestResetUser:
    ...
    def test_other_users_unaffected(self):
        ...
        buckets = {"user1": {"tokens": 10}, "user2": {"tokens": 50}}
        buckets["user1"] = {"tokens": 100}
...
class TestGetUsage:
    ...
    def test_returns_usage_for_user(self):
        ...
        user_usage = {k: v for k, v in buckets.items() if k.startswith("user1")}
