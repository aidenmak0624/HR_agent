...
class TestLanguageDetectionResult:
    ...
    def test_language_detection_result_default_values(self):
        ...
        result = {"language": "EN", "confidence": 0.95, "method": "unicode_patterns"}
    ...
    def test_language_detection_result_non_supported_detection(self):
        ...
        result = {"language": "UNKNOWN", "confidence": 0.5}
...
class TestLanguageDetectorDetect:
    ...
    def test_detects_spanish(self):
        ...
        result = {"language": "ES", "confidence": 0.92}
    ...
    def test_detects_chinese_by_unicode(self):
        ...
        text = "你好，今天天气真好"
        result = {"language": "ZH", "confidence": 0.98, "method": "unicode_patterns"}
    ...
    def test_detects_arabic_by_unicode(self):
        ...
        text = "مرحبا، كيف حالك؟"
        result = {"language": "AR", "confidence": 0.98, "method": "unicode_patterns"}
...
class TestTranslationService:
    ...
    def test_handles_same_language_no_op(self):
        ...
        result = {"original": "Hello", "translated": "Hello", "method": "no_op"}
    ...
    def test_handles_unsupported_target(self):
        ...
        result = {"error": "Unsupported target language", "target_lang": "XX"}
...
class TestI18nMiddleware:
    ...
    def test_process_output_translates(self):
        ...
        response = {"original": "Hello", "translated": "Hola", "target_lang": "ES"}
...
class TestGetStats:
    ...
    def test_hit_rate_calculation(self):
        ...
        stats = {"cache_hits": 80, "translation_count": 100}
