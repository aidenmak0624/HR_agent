...
class TestCounter:
    ...
    def test_counter_with_labels(self):
        ...
        counters = {("method", "GET"): 50, ("method", "POST"): 30, ("method", "PUT"): 10}
...
class TestGauge:
    ...
    def test_gauge_with_labels(self):
        ...
        gauges = {("status", "active"): 50, ("status", "inactive"): 10}
...
class TestHistogram:
    ...
    def test_histogram_get_buckets_structure(self):
        ...
        buckets = {"le_0.1": 0, "le_0.5": 2, "le_1.0": 5, "le_inf": 10}
...
class TestMetricsRegistry:
    ...
    def test_registry_get_all_returns_all(self):
        ...
        registry = {"counter1": {"value": 10}, "gauge1": {"value": 5}, "histogram1": {"count": 3}}
        assert len(registry) == 3

    def test_registry_reset_clears_all(self):
        """Test resetting registry."""
        registry = {"counter1": {"value": 10}, "gauge1": {"value": 5}}
        registry.clear()
    ...
    def test_registry_register_default_metrics(self):
        ...
        registry = {}
        defaults = ["http_requests_total", "llm_calls_total", "agent_queries_total"]
...
class TestMetricLabels:
    ...
    def test_gauge_with_labels(self):
        """Test gauge with labels."""
        gauges = {("connections", "host1"): 50, ("connections", "host2"): 30}
    ...
    def test_different_label_values_tracked_separately(self):
        ...
        assert (
            metrics[("requests", "endpoint", "/api/users")]
            != metrics[("requests", "endpoint", "/api/posts")]
        )
